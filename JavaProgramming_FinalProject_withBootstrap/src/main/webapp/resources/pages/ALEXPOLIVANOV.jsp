...
<nav class="navbar navbar-default">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="header-search">
                <div class="input-group input-group-lg">
                    ...
                    <span class="input-group-btn"><button form="searchForm" class="btn btn-default" type="button"><span
        ...
        <div class="col-md-2"></div>
        <div class="col-md-2">
            <a role="button" type="button" class="btn btn-link btn-lg reg" data-toggle="modal" data-target="#modal-1">Log
                In</a>
            <%--<a href="/login" role="button" type="button" class="btn btn-link btn-lg reg" data-toggle="modal" data-target="#modal-1">Log In</a>--%>
            <a role="button" type="button" class="btn btn-primary btn-lg reg" data-toggle="modal"
               data-target="#modal-2">Sign Up</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    ...
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-2"
                                data-dismiss="modal">Sing Up
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    ...
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-1"
            ...
            <div class="modal-footer">
                ...
                <div class="policy">
                    <p><strong>By signing up to create an account I accept EESN's Terms of Use and Privacy
                        Policy</strong></p>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div>
                    <p class="bg-danger warning2">Incorrect <strong>Full Name</strong> format, <strong>Email</strong> or
...
<div class="content">
    ...
    <aside class="col-xs-3">
        ...
        <form id="searchForm" role="form" method="post" action="/createActivities">
            ...
            <div class="checkbox">
                <label><input type="checkbox" name="checkOverSub" value="comp">Martial Arts</label><br>

                <div class="btn-group btn-group-justified">
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary btn-xs">Easy</button>
                        <button type="button" class="btn btn-primary btn-xs">Normal</button>
                        <button type="button" class="btn btn-primary btn-xs">Hard</button>
                    </div>
                </div>
            </div>
