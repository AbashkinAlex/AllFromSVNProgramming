...
public class EmployeesController {
    ...
    public ModelAndView showAll(@RequestParam(required = false) Integer id) throws SQLException {   //прилетает ID учреждений на котором вызвали "Посмотреть список работников"
